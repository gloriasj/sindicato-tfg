...
import {
  Box, TextField, Button, Typography, Alert, Stack, Divider,
} from '@mui/material';
...
export default function Register() {
  ...
  async function handleSubmit(e) {
    ...
    // Mandamos siempre 'delegado' por seguridad. El trigger de la BD
    // también lo tiene como valor por defecto, blindándolo por partida doble.
